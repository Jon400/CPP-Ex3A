...
namespace ariel
{
    class Fraction{
        ...
        public:
            Fraction(int = 1, int = 1); // constructor with default denominator and numerator of 1
            Fraction(float = 1.0); // constructor for floats
    ...
    Fraction reduce(Fraction); // reduces a fraction to its reduced form
